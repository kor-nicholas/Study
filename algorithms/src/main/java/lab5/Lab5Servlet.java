...
public class Lab5Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //Lab5View lab5view = new Lab5View();
        //String result = lab5view.showWord(request.getParameter("word"));
        String result = request.getParameter("word");
        //String result;
        //result = lab5view.showWord(request.getParameter("word"));
        
        /*Lab2View lab2view = new Lab2View();
        String result;
        try {
        result = lab2view.showResult(request.getParameter("word"));
        } catch (Exception ex) {
        result = "Сталася помилка, спробуйте ще раз";
        }*/
